...
void dae::StartMenuScene::LoadScene()
{
	...
	auto ButtonPressedAction = Action{ 0,new ButtonPressedCommand{},'K',-1,WORD(dae::ControllerButton::ButtonA),dae::PlayerOne };
	InputManager::GetInstance().AddAction(ButtonPressedAction);
	auto ButtonDownAction = Action{ 1, new ButtonDownCommand{},'S',-1,WORD(dae::ControllerButton::DownArrow),dae::PlayerOne };
	InputManager::GetInstance().AddAction(ButtonDownAction);
	auto ButtonUpAction = Action{ 2, new ButtonUpCommand{},'W',-1,WORD(dae::ControllerButton::UpArrow), dae::PlayerOne };
