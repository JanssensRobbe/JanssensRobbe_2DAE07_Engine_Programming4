...
void dae::Renderer::RenderTexture(const Texture2D& texture, const Rectf destRect, const Rectf srcRect) const
{
	SDL_Rect dst;
	dst.x = static_cast<int>(destRect.left);
	dst.y = static_cast<int>(destRect.bottom);
